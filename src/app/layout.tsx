...
export const metadata: Metadata = {
  title: "Brew & Bean | Specialty Coffee Shop & Cafe",
  description: "Discover handcrafted specialty coffee made from premium, ethically-sourced beans. Visit our cozy coffee shop for the perfect espresso, latte, and more.",
  keywords: "specialty coffee, espresso, cafe, coffee shop, artisan coffee, sustainable sourcing",
  ...
  openGraph: {
    ...
    description: "Experience handcrafted coffee beverages made with beans from sustainable sources worldwide.",
    type: "website",
    siteName: "Brew & Bean"
  },
  twitter: {
    card: "summary_large_image",
    title: "Brew & Bean - Your Perfect Cup Awaits",
    description: "Premium specialty coffee shop serving artisan beverages"
  },
  robots: {
    index: true,
    follow: true
